...
[⚗️ Pharma Portfolio Predictive Analysis](https://github.com/daiphuongngo/Pharma-Portfolio-Predictive-Analysis) | - Coded in `Python` and `AzureML` to analyze time-series pharmaceutical sales data and forecast the key pharma product and predict the patterns in the future
